...
export default function CreateProjectModal({
  ...
  const createProject = async (e: FormEvent) => {
    ...
    if (!name.trim() || !supabaseUrl.trim() || !supabaseKey.trim()) {
      toast.error("Please fill all the project details")
      return
    }
      ...
      <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={setOpen}>
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-neutral-800 p-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-md sm:p-6">
                <form>
                  <div>
