  ...
  return (
    <div className='py-5'>
      <p className='text-neutral-400 pb-4'>
        From your Supabase dashboard&apos;s SQL Editor, run the following query to set up triggers for each job.
      </p>
      <div className='relative'>
        ...
        >
          <ClipboardDocumentIcon className="h-6 w-6 text-black" aria-hidden="true" />
        </div>
      </div>
      <div className='my-4 p-2 px-4 rounded bg-yellow-600/50'>
        <p className='text-sm text-neutral-200'>
          Replace <code className='mx-2 px-1'>FROSTBYTE_API_KEY</code> and <code className='mx-2 px-1'>JOB_ID</code> before running this.
        </p>
      </div>
    </div>
  );
